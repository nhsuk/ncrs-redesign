...
module.exports = (router) => {
  router.post("/overviewtab/v3/nhs-number-search-post", function (req, res) {
    ...
    if (!nhsNumber) {
      ...
      return res.redirect("/overviewtab/v3/nhs-number-search");
    }

    res.redirect(`/overviewtab/v3/search-results?nhs-number=${nhsNumber}`);
  });

  router.post("/overviewtab/v3/basic-details-search", function (req, res) {
    ...
    if (Object.keys(req.session.data.errors).length) {
      return res.redirect("/overviewtab/v3/basic-details-search");
    }
    ...
    res.redirect(`/overviewtab/v3/search-results?${params}`);
  });

  router.post("/overviewtab/v3/advanced-details-search", function (req, res) {
    const gender = req.body["gender"];
    ...
    if (Object.keys(req.session.data.errors).length) {
      return res.redirect("/overviewtab/v3/advanced-details-search");
    }
  ...
  router.post("/overviewtab/v3/postcode-search-post", function (req, res) {
    ...
    if (Object.keys(req.session.data.errors).length) {
      return res.redirect("/overviewtab/v3/postcode-search-post");
    }
    ...
    res.redirect(`/overviewtab/v3/postcode-search-results?${params}`);
  });


  router.post("/overviewtab/v3/postcode-search-filter-post", function (req, res) {
    const search = req.body["searchfilter"];

    console.log('search: ' + search)

    res.redirect(`/overviewtab/v3/patient_2`);
  });
  ...
  router.get("/overviewtab/v3/postcode-search-results", function (req, res, next) {
  ...
  // for normal search
  router.get("/overviewtab/v3/search-results", function (req, res, next) {
 ...
 // router.get("/overviewtab/v3/patient_2", function (req, res, next) {
   // let formin = req.session.data['show'];
   
  
   
   // res.render("overviewtab/v3/patient_2#radios-here") 
   //  });
  ...
  //for overview1
  // router.get("/overviewtab/v3/overview", function (req, res, next) {
  ...
  //go to overview
  //  return res.render("overviewtab/v3/overview", {
  //   backtoresults: searchLink,
  //  });
  // });

  //for overview2
  // router.get("/overviewtab/v3/overview2", function (req, res, next) {
  //  let showsearch = req.query.search;
  //  if (showsearch === "true") {
  //   var searchLink = "true";
  //   } else {
  ...
  //  //go to overview2
  //    return res.render("overviewtab/v3/overview2", {
  //    backtoresults: searchLink,
  //  });
  // });
  ...
  //go to overview2
  //  return res.render("overviewtab/v3/patient_2", {
  //   backtoresults: searchLink,
  // });
  //  });

  // router.post("/overviewtab/v3/patient_2", function (req, res) {
